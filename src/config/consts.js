...
export const consts = {
  a11yLabel: {
    ...
    timePickerHint: 'Öffnet Zeitauswahl',
    ...
    lastName: 'Nachname',
    link: '(Link)',
    login: 'Anmelden (Taste)',
    loginHint: 'Zum Anmeldeformular wechseln',
    logout: 'Abmelden (Taste)',
    logoutHint: 'Vom Konto abmelden',
  ...
  MATOMO_TRACKING: {
    SCREEN_VIEW: {
      ...
      NEWS_ITEMS: 'News',
      NOTICEBOARD: 'Noticeboard',
      PARTICIPATION_PROJECT: 'Participation project',
  ...
  ROOT_ROUTE_NAMES: {
    ...
    NOTICEBOARD: 'Noticeboard',
    PARTICIPATION_PROJECTS: 'ParticipationProjects',
