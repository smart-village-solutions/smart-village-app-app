...
export const texts = {
  ...
  floorPlan: {
    ...
    floorAccessibilityHint: 'Wechselt zu diesem Stockwerk.',
    floorChanged: (title) => `${title} ausgewählt.`,
    listAccessibilityLabel: 'Orte im Lageplan',
    listView: 'Liste',
    listViewAccessibilityHint: 'Zeigt alle Orte des Lageplans als Liste.',
    listViewAccessibilityLabel: 'Listenansicht öffnen',
    linkedContent: 'Verknüpfung',
    openLinkedContent: 'Verknüpften Inhalt öffnen',
    reset: 'Reset',
    resetAccessibilityHint: 'Setzt Zoom und Position des Lageplans zurück.',
    resetAccessibilityLabel: 'Planansicht zurücksetzen',
    selected: 'ausgewählt',
    svgError: 'Der Lageplan konnte nicht geladen werden.',
    svgFallback: 'Es ist kein SVG für den Lageplan hinterlegt.',
    svgView: 'Plan',
    svgViewAccessibilityHint: 'Zeigt den interaktiven Lageplan.',
    svgViewAccessibilityLabel: 'Planansicht öffnen',
    typeLabels: {
      info: 'Information',
      room: 'Raum',
      service: 'Service',
  ...
  profile: {
    ...
    forms: {
      ...
      addLinks: 'Link hinzufügen',
      addOpeningHours: 'Öffnungszeit hinzufügen',
      addPriceInformation: 'Preiskategorie hinzufügen',
      address: 'Adresse',
      categories: 'Kategorien',
      categoriesPlaceholder: 'Wählen Sie hier eine oder mehrere Kategorien aus',
      city: 'Ort',
      cityError: 'Der Ort muss ausgefüllt werden',
      cityPlaceholder: 'Geben Sie hier einen Ort ein',
      contacts: {
        deleteButtonAccessibility: 'Kontakt löschen',
        email: 'E-Mail',
        ...
        phone: 'Telefon',
        phonePlaceholder: 'Geben Sie hier eine Telefonnummer ein',
        surname: 'Nachname',
        surnamePlaceholder: 'Geben Sie hier einen Nachnamen ein',
        title: 'Kontakt',
        url: 'URL',
      ...
      coordinates: 'Geo-Koordinaten',
      date: 'Veröffentlichungsdatum',
      datePlaceholder: 'Wählen Sie ein Veröffentlichungsdatum aus',
      description: 'Beschreibung',
      descriptionError: 'Die Beschreibung muss ausgefüllt werden',
      ...
      eventContact: 'Ansprechpartner für die Veranstaltung',
      ...
      priceInformation: {
        amount: 'Preis',
        amountPlaceholder: 'Geben Sie hier einen Preis ein',
        deleteButtonAccessibility: 'Preiskategorie löschen',
        description: 'Beschreibung',
        descriptionPlaceholder: 'Geben Sie hier eine Beschreibung ein',
      ...
      regionNameError: 'Die Ortsbezeichnung muss ausgefüllt werden',
      regionNamePlaceholder: 'Geben Sie hier eine Ortsbezeichnung ein',
      renewalInterval: 'Wiederholungsintervall',
      renewalIntervalDaily: 'Tag(e)',
      renewalIntervalMonthly: 'Monat(e)',
      renewalIntervalPlaceholder: 'Wählen Sie ein Wiederholungsintervall aus',
      renewalIntervalWeekly: 'Woche(n)',
      renewalIntervalYearly: 'Jahr(e)',
      repeatInterval: 'Jede/Alle',
      repeatIntervalError: 'Das Wiederholungsintervall muss ausgefüllt werden',
      ...
      startTime: 'Startzeit',
      startTimePlaceholder: 'Wählen Sie eine Startzeit aus',
      street: 'Straße',
      streetError: 'Die Straße muss ausgefüllt werden',
      streetPlaceholder: 'Geben Sie hier eine Straße ein',
      subTitle: 'Einleitung',
      subTitleError: 'Der Teaser muss ausgefüllt werden',
      subTitlePlaceholder: 'Geben Sie hier einen Teaser ein',
      text: 'Text',
      textError: 'Der Text muss ausgefüllt werden',
      textPlaceholder: 'Geben Sie hier einen Text ein',
      title: 'Überschrift',
      titleError: 'Die Überschrift muss ausgefüllt werden',
      titlePlaceholder: 'Geben Sie hier eine Überschrift ein'
    },
    gender: 'Anrede',
    hint: 'Hinweis',
