...
export const texts = {
  ...
  profile: {
    ...
    forms: {
      abort: 'Abbrechen',
      addContact: 'Ansprechpartner für die Veranstaltung',
      addImages: 'Bilder hinzufügen',
      addLinks: 'Links hinzufügen',
      addOpeningHours: 'Öffnungszeiten hinzufügen',
      addPriceInformation: 'Preisinformationen hinzufügen',
      city: 'Ort',
      ...
      description: 'Inhalt',
      descriptionError: 'Der Inhalt muss ausgefüllt werden',
      descriptionPlaceholder: 'Geben Sie hier einen Inhalt ein',
      endDate: 'Enddatum',
      ...
      renewalIntervalDaily: 'Täglich',
      renewalIntervalMonthly: 'Monatlich',
      renewalIntervalWeekly: 'Wöchentlich',
      renewalIntervalYearly: 'Jährlich',
      openingHourGroup: {
        day: 'Wochentag',
      ...
      placeNameError: 'Der Ort muss ausgefüllt werden',
      placeNamePlaceholder: 'Geben Sie hier einen Ort ein',
