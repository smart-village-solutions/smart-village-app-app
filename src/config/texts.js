...
export const texts = {
  ...
  noticeboard: {
    ...
    carpoolFrequencyOneTime: 'Einmalig',
    carpoolFrequencyRegularly: 'Regelmäßig',
    categoryNames: {
    ...
    inputAutoBrand: 'Auto Marke',
    inputAutoColor: 'Auto Farbe',
    inputAvailablePlaces: 'Verfügbare Plätze',
    inputAvailablePlacesError: 'Verfügbare Plätze müssen eine Zahl sein',
    inputCheckbox: 'Einverständnis zur Datenverarbeitung',
    inputComments: 'Bemerkungen',
    inputDate: (requestedDateDifference) => `Laufzeit (max. ${requestedDateDifference} Monate)`,
    inputDepartureAddress: 'Abfahrtsadresse',
