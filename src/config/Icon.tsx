...
export const Icon = {
  ...
  Bus: (props: TablerIconsProps) => <IconBus stroke={0.67} {...props} />,
  ...
  Metro: (props: TablerIconsProps) => <IconTrain stroke={0.67} {...props} />,
  NamedIcon,
  ...
  Railway: (props: TablerIconsProps) => <IconTrain stroke={0.67} {...props} />,
  ...
  Tram: (props: TablerIconsProps) => <IconAerialLift stroke={0.67} {...props} />,
