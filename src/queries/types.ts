...
export const getQueryType = (input: string) => {
  ...
  const availableTypes = [
    ...
    QUERY_TYPES.VOLUNTEER.CONVERSATIONS,
    QUERY_TYPES.VOLUNTEER.GROUP,
    QUERY_TYPES.VOLUNTEER.GROUPS,
    QUERY_TYPES.VOLUNTEER.GROUPS_MY,
    QUERY_TYPES.VOLUNTEER.HOME,
    QUERY_TYPES.VOLUNTEER.ME,
    QUERY_TYPES.VOLUNTEER.PERSONAL,
    QUERY_TYPES.VOLUNTEER.PROFILE,
    QUERY_TYPES.VOLUNTEER.STREAM,
