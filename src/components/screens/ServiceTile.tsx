...
export const ServiceTile = ({
  ...
  const hasFontStyle = !!Object.keys(fontStyle).length;
  const hasIconStyle = !!Object.keys(iconStyle).length;
        ...
        <View style={!isVisible && styles.invisible}>
          {item.iconName ? (
            <Icon.NamedIcon
              ...
              style={[styles.serviceIcon, hasIconStyle && iconStyle]}
            />
          ) : item.svg ? (
            <IconUrl
              color={
