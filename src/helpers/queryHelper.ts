...
export const rootRouteName = (query: string) =>
  ({
    ...
    [QUERY_TYPES.VOLUNTEER.CALENDAR]: ROOT_ROUTE_NAMES.VOLUNTEER,
    [QUERY_TYPES.VOLUNTEER.CALENDAR_ALL]: ROOT_ROUTE_NAMES.VOLUNTEER,
    [QUERY_TYPES.VOLUNTEER.CALENDAR_ALL_MY]: ROOT_ROUTE_NAMES.VOLUNTEER,
    [QUERY_TYPES.VOLUNTEER.CONVERSATION]: ROOT_ROUTE_NAMES.VOLUNTEER,
    [QUERY_TYPES.VOLUNTEER.CONVERSATIONS]: ROOT_ROUTE_NAMES.VOLUNTEER,
    [QUERY_TYPES.VOLUNTEER.GROUP]: ROOT_ROUTE_NAMES.VOLUNTEER,
    [QUERY_TYPES.VOLUNTEER.GROUPS]: ROOT_ROUTE_NAMES.VOLUNTEER,
    [QUERY_TYPES.VOLUNTEER.GROUPS_MY]: ROOT_ROUTE_NAMES.VOLUNTEER,
    [QUERY_TYPES.VOLUNTEER.HOME]: ROOT_ROUTE_NAMES.VOLUNTEER,
    [QUERY_TYPES.VOLUNTEER.ME]: ROOT_ROUTE_NAMES.VOLUNTEER,
    [QUERY_TYPES.VOLUNTEER.PERSONAL]: ROOT_ROUTE_NAMES.VOLUNTEER,
    [QUERY_TYPES.VOLUNTEER.PROFILE]: ROOT_ROUTE_NAMES.VOLUNTEER,
    [QUERY_TYPES.VOLUNTEER.STREAM]: ROOT_ROUTE_NAMES.VOLUNTEER,
    [QUERY_TYPES.VOLUNTEER.USER]: ROOT_ROUTE_NAMES.VOLUNTEER,
    [QUERY_TYPES.VOLUNTEER.USER_NOTIFICATION_SETTINGS]: ROOT_ROUTE_NAMES.VOLUNTEER
  }[query]);
